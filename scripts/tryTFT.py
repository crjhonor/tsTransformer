...
if train_model:
    trainer = pl.Trainer(
        ...
        max_epochs=1000,
        callbacks=[
            pl.callbacks.EarlyStopping(monitor='val_loss', patience=12),
...
pred_df.to_csv(Path(os.getcwd()).parent / f'outputs/pred_dfs/tag_metric_label.csv')

print(pred_df.xs('TA0Close'))
