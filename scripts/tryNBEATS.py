...
performance_show.to_csv(Path(os.getcwd()).parent / 'assa/model/performance_metrics/NBEATS_metric_record.csv')
pred_df.to_csv(Path(os.getcwd()).parent / 'outputs/pred_dfs/NBEATS_metric_label.csv')
